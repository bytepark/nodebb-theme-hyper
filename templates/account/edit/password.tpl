		...
		<div class="col-md-12">
			<form class="form-horizontal edit-form">
				...
				<div class="form-group">
					<label class="form-label col-sm-3 col-lg-2 control-label" for="inputCurrentPassword">[[user:current_password]]</label>
				...
				<div class="form-group">
					<label class="form-label col-sm-3 col-lg-2 control-label" for="inputNewPassword">[[user:password]]</label>
					<div class="col-sm-9 col-lg-10">
				...
				<div class="form-group">
					<label class="form-label col-sm-3 col-lg-2 control-label" for="inputNewPasswordAgain">[[user:confirm_password]]</label>
					<div class="col-sm-9 col-lg-10">
